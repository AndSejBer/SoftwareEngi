...
# 	Given that I have a Worker "abc1"
# 	When I work on the activity and add the time used: ""
# 	Then I get the error "Activity must exist before time can be added"
# 	
#Scenario: Worker works two times on a project
#	Given that I have a Worker "abc1"
# 	And I have an activity with name "" and time-estimate ""
# 	And Worker "abc1" takes activity ""
# 	And I work on the activity and add the time used: ""
# 	When I work on the activity and add the time used: ""
# 	Then The activity has accumulated "" amount of time
# 	
